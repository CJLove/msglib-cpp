...
void Timer::timerEvent() { m_mailbox.SendSignal(m_label); }
...
void TimerManager::StartTimer(const Label &label, const std::chrono::time_point<std::chrono::system_clock, std::chrono::nanoseconds> &time)
{
